...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initMenuMobile)\n/* harmony export */ });\n/* harmony import */ var _outsideclick_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./outsideclick.js */ \"./js/modules/outsideclick.js\");\n\nfunction initMenuMobile() {\n  var menuButton = document.querySelector('[data-menu=\"button\"]');\n  var menuList = document.querySelector('[data-menu=\"list\"]');\n  var eventos = ['click', 'touchstart'];\n  if (menuButton) {\n    var openMenu = function openMenu(event) {\n      _menuList.classList.add('active');\n      _menuButton.classList.add('active');\n      (0,_outsideclick_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(_menuList, _eventos, function () {\n        _menuList.classList.remove('active');\n        _menuButton.classList.remove('active');\n      });\n    };\n    var _menuButton = document.querySelector('[data-menu=\"button\"]');\n    var _menuList = document.querySelector('[data-menu=\"list\"]');\n    var _eventos = ['click', 'touchstart'];\n    ;\n    _eventos.forEach(function (userEvent) {\n      _menuButton.addEventListener(userEvent, openMenu);\n    });\n  }\n  ;\n}\n;\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/menu-mobile.js?");
